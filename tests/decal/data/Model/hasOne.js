describe('hasOne', function () {
  ...
  it('should properly deserialize hasOnes.', function () {
  ...
  it('should properly serialize hasOnes.', function () {
    let Light = decal.Model.extend({
      modelKey: 'light',
      isOn: decal.attr({defaultValue: false})
    })
  ...
  it('should properly deserialize embedded hasOnes.', function () {
    let Light = decal.Model.extend({
      modelKey: 'light',
      isOn: decal.attr({defaultValue: false})
    })
    ...
    let LightSwitch = decal.Model.extend({
      modelKey: 'lightSwitch',
      collectionKey: 'lightSwitches',
      light: decal.hasOne('light', {embedded: true}),
      flip: function () {
        this.light.isOn = !this.light.isOn
      }
    })
  ...
  it('should properly serialize embedded hasOnes.', function () {
    let Light = decal.Model.extend({
      modelKey: 'light',
      isOn: decal.attr({defaultValue: false})
    })
  ...
  it('should allow filtering.', function () {
    ...
    let LightSwitch = decal.Model.extend({
      ...
      light: decal.hasOne('light', {embedded: true}),
      linkedTo: decal.hasOne('light', {embedded: true, readOnly: true}),
      linkedToNull: decal.hasOne('light', {embedded: true, defaultValue: null}),
